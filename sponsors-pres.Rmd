...
+ __Bronze - General - £100__
  - Logo displayed on website
  - Booth (table, chairs, power)
  - Anouncement on [satRdays twitter](https://twitter.com/satRdays_org)

+ __Silver - Coffee - £300__
  - Everything in Bronze +
  - Branding prominently displayed in the coffee break
  - Announcement during the coffee break

+ __Gold - Lunch - £600__ 
  - Everything in Bronze +
  - Branding prominently displayed during lunch
  - Announcement during lunch

+ __Platinum - Keynote - £1000__
  - Everything in Bronze +
  - Slide displayed before the keynote
  - Announcement before the keynote
...
+ Feel free to run a raffle, no matter the sponsorship tier
+ Raffle announcement and prize giving will be at the end of the conference event (~5pm)
+ Please communicate your interest to satrday.cardiff@gmail.com before hand, this will help with scheduling and organisation
...
- [CaRdiff R User Group](https://www.meetup.com/Cardiff-R-User-Group/)
  - Community run R user group for all levels founded in 2015 to provide informal training and support
...
Dave, Paul, Heather, Dom, Sefa, Mark, Steph
